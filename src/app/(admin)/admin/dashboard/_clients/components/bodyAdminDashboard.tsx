...
import { TrendingUp, TrendingDown, Package, Users, DollarSign, ShoppingCart, AlertTriangle, CheckCircle, LucideIcon } from "lucide-react"
...
interface IMetricCard {
    ...
    isPositive?: boolean; // optional dengan default true
}

const MetricCard = ({ title, value, change, icon: Icon, isPositive = true }: IMetricCard) => (
        ...
        <div>
            ...
            <div className="flex items-center space-x-4 mt-1">
                ...
                <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-600">{item.lowStock} low stock</span>
                </div>
                <div className="flex items-center">
                    <TrendingDown className="h-4 w-4 text-red-500 mr-1" />
                    <span className="text-sm text-gray-600">{item.outOfStock} out of stock</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Motorcycle Body Parts Dashboard</h1>
                            <p className="text-gray-600 mt-1">Monitor your business performance and inventory status</p>
                        </div>
                        <div className="text-right">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600">Sales distribution by category</p>
                        </div>
                        <div className="h-80">
                            <ResponsiveContainer width="100%" height="100%">
                                <PieChart>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600">Monthly active customers trend</p>
                        </div>
                        <div className="h-64">
                            <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-600">Current stock levels across product categories</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="p-4 bg-green-50 rounded-lg">
                            <h4 className="font-semibold text-green-800 mb-2">Strong Growth</h4>
                            <p className="text-sm text-green-700">Revenue increased 18.9% this month with strong demand for fairing products</p>
                        </div>
                        <div className="p-4 bg-blue-50 rounded-lg">
                            <h4 className="font-semibold text-blue-800 mb-2">Customer Acquisition</h4>
                            <p className="text-sm text-blue-700">New customer acquisition up 26.6%, indicating effective marketing strategies</p>
                        </div>
                        <div className="p-4 bg-yellow-50 rounded-lg">
                            <h4 className="font-semibold text-yellow-800 mb-2">Inventory Alert</h4>
                            <p className="text-sm text-yellow-700">Some products running low on stock, consider restocking popular items</p>
                        </div>
                    </div>
                </div>
            </div>
