...
export interface ISelectOptionSearchProps {
    ...
    setFieldValue: (field: string, value: string, shouldValidate?: boolean) => Promise<void | FormikErrors<IInitialValuesAddProduct>>
}
...
export interface ISelectOptionCategoryProps {
    setValueDisplay: React.Dispatch<React.SetStateAction<{
        categoryMotor: string
        category: string
    }>>
    valueDisplay: {
    ...
    setFieldValue: (field: string, value: string, shouldValidate?: boolean) => Promise<void |
        FormikErrors<IInitialValuesAddProduct>>
