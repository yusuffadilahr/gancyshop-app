import { useMutateEditProduct } from "@/app/(admin)/admin/produk/_clients/hooks/use-mutate-edit-product";
import { IModalEditProductProps } from "@/app/(admin)/admin/produk/_clients/types";
