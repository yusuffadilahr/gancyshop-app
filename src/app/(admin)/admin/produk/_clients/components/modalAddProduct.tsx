import { IDataCategoryName, IModalAddProductProps } from "@/app/(admin)/admin/produk/_clients/types";
...
import SelectOptionCategoryMotorSearch from "@/app/(admin)/admin/produk/_clients/components/selectOptionCategoryMotor";
import SelectOptionCategorySearch from "@/app/(admin)/admin/produk/_clients/components/selectOptionCategory";
import { handleGetDataCategoryByCategoryMotor } from "@/app/(admin)/admin/produk/_servers/services";
