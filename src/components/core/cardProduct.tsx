import { formatWeight } from "@/app/_clients/utils/formatConverter";
    ...
    <Card className="overflow-hidden flex flex-col h-fit">
      ...
      <CardContent className="p-4 flex flex-col justify-between">
        ...
        <div className="mt-2 space-y-1">
          ...
          <p className="text-xs text-gray-600">Stok: {productStock} Pcs</p>
          <p className="text-xs text-gray-600">
            Gramasi Pengiriman: {formatWeight(productWeight)}
          </p>
